...
import (
	...
	"github.com/pseudonative/restaurant/helpers"
	"github.com/pseudonative/restaurant/models"
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while listin users items"})
		}
		var allUsers []bson.M
...
func GetUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while geting user items"})
		}
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "users not found"})
			return
		}
